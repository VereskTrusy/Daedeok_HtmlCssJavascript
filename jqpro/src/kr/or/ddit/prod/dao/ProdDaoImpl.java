...
public class ProdDaoImpl implements IProdDao {
	...
	public List<ProdVo> selectByLguList(String lprod_lgu) {
		...
		System.out.println("[SQL]     [ProdDaoImpl.selectByLguList.Sql] SELECT PROD_ID, PROD_NAME FROM PROD WHERE PROD_LGU =" + lprod_lgu);
	...
	public ProdVo selectByProdId(String prod_id) {
		...
		System.out.println("[SQL]     [ProdDaoImpl.selectByProdId.Sql] SELECT * FROM PROD WHERE PROD_ID = " + prod_id);
